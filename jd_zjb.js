...
京东极速版赚金币
更新时间：2021-6-12
活动入口：极速版 百元生活费 赚金币 邀请好友
温馨提示：第一次运行可不填写邀请码 运行一次查看自己的邀请码
export InviterPin="" 填写你的邀请码
脚本兼容: QuantumultX, Surge, Loon, JSBox, Node.js
===================quantumultx================
[task_local]
#京东极速版赚金币
0 5 * * * jd_zjb.js, tag=京东极速版赚金币, img-url=https://raw.githubusercontent.com/Orz-3/mini/master/Color/jd.png, enabled=true

=====================Loon================
[Script]
cron "0 5 * * *" script-path=jd_zjb.js, tag=京东极速版赚金币

====================Surge================
京东极速版赚金币 = type=cron,cronexp="0 5 * * *",wake-system=1,timeout=3600,script-path=jd_zjb.js

============小火箭=========
京东极速版赚金币 = type=cron,script-path=jd_zjb.js, cronexpr="0 5 * * *", timeout=3600, enable=true
 */
